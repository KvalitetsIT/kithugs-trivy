...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("kithugs-trivy");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "kithugs-trivy-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/kithugs-trivy-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("kithugs-trivy")
